...
const plans = [
  { name: "SILVER", slug: "silver", subtitle: "Perfect start for a healthier you", price: "₹700", mealImage: "/images/subscriptions/silver-meal.png", badge: "silver", features: ["6 Meals Per Week", "High Protein Options", "Customizable Protein", "One Delivery Per Day", "Skip & Reschedule Meals"] },
  { name: "GOLDEN", slug: "golden", subtitle: "Best balance of taste & nutrition", price: "₹1,100", mealImage: "/images/subscriptions/golden-meal.png", badge: "gold", popular: true, features: ["6 Meals Per Week", "High Protein & Clean Meals", "Customizable Protein", "One Delivery Per Day", "Priority Support"] },
  { name: "DIAMOND", slug: "diamond", subtitle: "Ultimate nutrition experience", price: "₹1,600", mealImage: "/images/subscriptions/diamond-meal.png", badge: "diamond", features: ["6 Premium Meals Per Week", "High Protein & Gourmet Meals", "Customizable Protein", "One Delivery Per Day", "Priority Support"] },
];
          ...
          {plans.map((plan) => (
            <div key={plan.name} className={`relative overflow-hidden rounded-[20px] border bg-[#08090a] ${plan.popular ? "border-[#E63946]" : "border-white/25"}`}>
              ...
              <div className="relative min-h-[560px] p-8">
                ...
                <div className="absolute right-[-10px] top-[85px] h-[215px] w-[245px]"><Image src={plan.mealImage} alt={`${plan.name} meal`} fill sizes="245px" className="object-contain object-right" priority /></div>
