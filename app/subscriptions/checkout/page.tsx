    ...
    <div className="grid gap-8 lg:grid-cols-[1fr_340px]">
      <section>
        ...
        <div className="rounded-[32px] border border-white/10 bg-white/[0.035] p-6 sm:p-9">
          ...
          {step === 5 && <><h1 className="mt-3 text-3xl font-bold">Pay with UPI</h1><div className="mt-8 rounded-2xl border border-white/10 bg-black/20 p-6"><p className="text-sm text-white/60">Pay ₹{plan.price} to <b className="text-white">{UPI_VPA}</b></p><button type="button" onClick={openUPI} className="mt-5 w-full rounded-2xl bg-[#E63946] px-5 py-4 font-bold">Open UPI App</button><label className="mt-5 flex items-center gap-3 text-sm text-white/60"><input type="checkbox" checked={paymentDone} onChange={(e) => setPaymentDone(e.target.checked)} /> I've Completed Payment</label></div></>}
